...
/**
   Class to hold the media's metadata.  AdMetadata are used
   ...
   AdMetadata is like a Bundle. It is sparse and each key can occur at
...
public class AdMetadata
{
    ...
    private static final String TAG = "media.AdMetadata";
    ...
    // Map to associate a AdMetadata key (e.g TITLE) with the offset of
     ...
     *
     * @param parcel With the serialized data. AdMetadata keeps a
     ...
     * @param val AdMetadata key to test.
